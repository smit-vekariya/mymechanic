            ...
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                ...
                if (isset($_GET['updatecat'])) {
                    ...
                    <input id="updatecatimage"  name="updatecatimage" type="file" />
                        ...
                        <input type="text" maxlength="30" class="form-control my-1" id="updatecatby" value="mymechanic" name="updatecatby" disabled>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple4">
                                ...
                                <tbody>
                                    <?php
                                    $sql1 = "SELECT *FROM `category` WHERE `cat_by` = 'mymechanic'";
                ...
                <div class="modal-body">
                    <form method="POST" action="<?php echo $_SERVER['PHP_SELF'] . '?addcat=true'; ?>" class="customer-form" enctype="multipart/form-data">
                        ...
                        <div style="width:100%">
                            ...
                            <p style="margin-bottom: 0px; font-size: 14px; color: black;">Category By :</p>
                            <input type="text" maxlength="30" class="form-control" id="catby" name="catby" value="mymechanic" disabled>
                        </div>
