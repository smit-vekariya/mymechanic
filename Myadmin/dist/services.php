...
if (isset($_GET['addser'])) {
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if ($imagevalid == true) {  
            ...
            $sql4 = "INSERT INTO `service` (`cat_id`,`s_image`,`s_name`, `s_description`, `s_special1`, `s_special2`, `s_special3`, `s_price`,`s_by`, `s_status`) VALUES ('$cat_id','$service_img', '$service_name', '$service_des', '$special1', '$special2', '$special3', '$service_charge', '$service_by','Active')";
        ...
        <main>
            ...
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                ...
                if (isset($_GET['updateser'])) {
                    ...
                    $selcat = "SELECT *FROM `category` WHERE `cat_by` = 'mymechanic'";
                    ...
                    echo '</select>
                        ...
                        <div style="width:100%" class="my-3">
                            ...
                            <input type="text" maxlength="30" class="form-control my-1" id="upservice_by" value="mymechanic" name="upservice_by" disabled>
                        </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple5">
                                ...
                                <tbody>
                                    <?php
                                    $selectser = "SELECT *FROM `service` WHERE `s_by` = 'mymechanic'";
                ...
                <div class="modal-body">
                    <form method="POST" action="<?php echo $_SERVER['PHP_SELF'] . '?addser=true'; ?>" class="customer-form" enctype="multipart/form-data">
                        ...
                        <div style="width:100%" class="my-3">
                            ...
                            <p style="margin-bottom: 0px; font-size: 14px; color: black;">Service By :</p>
                            <input type="text" maxlength="30" class="form-control my-1" id="service_by" value="mymechanic" name="service_by" disabled>
                        </div>
